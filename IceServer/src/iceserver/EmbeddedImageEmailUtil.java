            ...
            throws AddressException, MessagingException
    {
        try
        {
            ...
            /*
                ...
                message.setSubject(new String(subject.getBytes("ISO-8859-1"),"KOI8_R"), "koi8-r");
                message.setText(new String(body.getBytes("ISO-8859-1"),"KOI8_R"), "koi8-r");
                message.saveChanges();
             * 
                    partAttach.setFileName(
             * MimeUtility.encodeText( new String( fileName.getBytes( "utf-8" ) ), "Cp1251", "B" ) );
            */
            //messageBodyPart.setFileName(fileName);
            messageBodyPart.setFileName(MimeUtility.encodeText( new String( fileName.getBytes( "utf-8" ) ), "Cp1251", "B" ) );
